...
public class StrangerMonitoringViewAdapter extends ArrayAdapter<MonitoringView> {
    ...
    public StrangerMonitoringViewAdapter(Context context, int resource, List<MonitoringView> monitors) {
